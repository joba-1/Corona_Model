...
list_of_n_9 = [Point(47.7728352, 12.0062484), Point(
    47.7973373, 11.9747759), Point(47.7610224, 12.0510184)]
list_of_n_10 = [Point(8.0172, 53.39422), Point(7.99973, 53.3675)]
list_of_n_11 = [Point(9.70088, 51.22621), Point(9.69110, 51.21141), Point(9.72293, 51.19661), Point(
    9.76303, 51.17931), Point(9.79662, 51.21392), Point(9.82794, 51.20514), Point(9.64599, 51.19812)]
list_of_n_12 = [Point(12.42153, 51.84190), Point(12.40572, 51.79565),
                Point(12.34469, 51.80463), Point(12.35341, 51.84544)]
list_of_n_13 = [Point(9.17492, 50.16440), Point(9.18954, 50.15995), Point(9.21508, 50.17192), Point(
    9.23338, 50.18020), Point(9.19677, 50.18895), Point(9.19646, 50.14921)]
list_of_n_14 = [Point(13.00774, 48.273556), Point(13.008913, 48.260859), Point(
    13.020287, 48.2657), Point(13.031493, 48.27723), Point(13.04637, 48.275227)]
...
locations.to_file('input_data/geo/Buildings_'+places[loc][0].split(',')[0].replace(' ', '_') +
                  '_MA_'+str(min_area).replace('.', '_')+'.geojson', driver='GeoJSON')
df = pd.DataFrame(locations)
df.to_csv('input_data/geo/Buildings_'+places[loc][0].split(',')[0].replace(' ',
                                                            '_')+'_MA_'+str(min_area).replace('.', '_')+'.csv')
