...
scenarios = [{'run':0 ,'max_time': 10, 'start_2':200, 'start_3':500, 'closed_locs':[],                         'reopen_locs':[],                          'infectivity':0.5, 'name':'no_mitigation'},
...
if __name__ == '__main__':
    ...
    input_folder =  'saved_objects/Gangelt_big_Hmix_Imatrix/' 
    ...
    for p in p_range:
        ...
        scenario_and_parameter = 'New_Parameters_TEST_HmixImatrix_Ifreq_1_'+used_scenario['name'] +'_'+str(parameter)+'_'+'{:.3f}'.format(p)
