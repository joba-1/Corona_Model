    ...
    for line in input_file:
        ...
        if line[0]:
            if line[0][0].isdigit() or line[0][0] == 'i':
                schedules[float(line[0])] = [
                    [{'times': [], 'locs':[], 'type':line[24].strip('\n')}], [float(line[2])]]
            ...
            schedules[current_key][0].append(
                {'times': [], 'locs': [], 'type': line[24].strip('\n')})
        ...
        if line[3]:
            ...
            if line[3] == 'standard':
                ...
                if line[4]:
                    ...
                    duration = int(line[3][1:])
                # -number of days with entry when days are finished
